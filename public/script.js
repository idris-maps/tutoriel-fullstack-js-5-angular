...
return i}({1:[function(t,e,n){function r(t){t.data=[{text:"Manger",fait:!0},{text:"Dormir",fait:!1}],t.ajouter=function(){t.nouveau&&(t.data.push({text:t.nouveau,fait:!1}),t.nouveau="")},t.supprimerFait=function(){var e=[]
t.data.forEach(function(t){t.fait||e.push(t)}),t.data=e},t.basculerFait=function(e){t.data[e].fait?t.data[e].fait=!1:t.data[e].fait=!0},t.basculerMaj=function(e){t.data[e].maj?t.data[e].maj=void 0:(t.data.forEach(function(t){t.maj&&(t.maj=void 0)}),t.data[e].maj=!0)},t.mettreAJour=function(e){this.nouveauText&&(t.data[e].text=this.nouveauText,t.data[e].maj=void 0,this.nouveauText="")}}var i=t("angular"),o=i.module("aFaire",[])
r.$inject=["$scope"],o.controller("aFaireCtrl",["$scope",r])},{angular:3}],2:[function(t,e,n){!function(t){"use strict"
